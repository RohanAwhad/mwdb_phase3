...
print(query_image,"test")
query_image_disp, _ = dataset[query_image]
if query_image_disp.mode != "RGB": query_image_disp = query_image_disp.convert('RGB')
display_images(query_image_disp,k_near_images)
img_relevance = {}
counter = 10
...
display_images(query_image_disp,processed_images)